...
# dll_name = "test_l1_e12_h10"
# dll_name = "test_l1_e8_h10"
# dll_name = "test_l1_e4_h10"
dll_name = "test_l1_e2_h10"
...
class FilteredListener(can.Listener):
    ...
    def process_speed_data(self, msg):
        ...
        net_in = self.data_vector[0].astype(np.float32).flatten(order='C')
