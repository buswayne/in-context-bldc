...
def dynamics(x, u, P_Rs, P_Ls, P_Kt, P_J, P_b, magnitude):
    """ System dynamics function (discrete time, PyTorch version for GPU) """

    theta0 = 0
    P = 7

    Rs = P_Rs *10**magnitude[0]
    Ls = P_Ls *10**magnitude[1]
    Kt = P_Kt *10**magnitude[2]
    J = P_J *10**magnitude[3]
    b = P_b *10**magnitude[4]
