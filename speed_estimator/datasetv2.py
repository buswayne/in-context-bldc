...
def load_dataframes_from_folder(folder_path, validation_split = 0.3):
    '''
    ...
    training_size = np.floor(dataset_length * (1 - validation_split))
    ...
    for file_idx in np.arange(dataset_length):
        ...
        if file_idx < training_size:
            ...
            dataframes_validation.append(df)
 
    return dataframes_training, dataframes_validation
