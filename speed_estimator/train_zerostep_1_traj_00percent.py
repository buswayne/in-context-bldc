...
checkpoint_name_to_save = "model 1 layer"
checkpoint_name_to_open = "model 1 layer"
...
folder_path_training = ['/home/DATA/shared/st/50_percent_control/00_percent_high_speed/1_traj']
folder_path_val = ['/home/DATA/shared/st/50_percent_control/00_percent_high_speed/1_traj']
...
if wandb_record:
    ...
    wandb.init(
        ...
        project="in-context bldc estimator 1 trajectory 0 percent",
