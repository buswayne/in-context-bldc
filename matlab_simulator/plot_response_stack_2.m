...
savefig(figname)
saveas(gcf, sprintf("exp_results_CAN_2/stack_results%s.png", models_to_test(1)))
fig = gcf;
set(fig, 'PaperPositionMode', 'auto');
exportgraphics(fig, sprintf("exp_results_CAN_2/stack_results%s.pdf", models_to_test(1)), 'ContentType', 'vector');
