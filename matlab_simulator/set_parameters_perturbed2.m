...
%ora anche coeff_inertia dipende dalla perturbation
...
coeff_inertia = @(x) 1 - perturbation + perturbation * (0.1 + 9.9 * x);
...
disc.Inertia = (8.7749e-04 - 44e-07) * coeff_inertia(rand());
