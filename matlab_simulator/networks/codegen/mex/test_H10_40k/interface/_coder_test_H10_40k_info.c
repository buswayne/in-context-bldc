...
/* Include files */
#include "_coder_test_H10_40k_info.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "QualifiedName",
                emlrtMxCreateString("test_H10_40k"));
  ...
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(740010.44850694446));
...
/* End of code generation (_coder_test_H10_40k_info.c) */
