 ...
 * File: _coder_ndp_random_correction_short_api.c
 *
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "ndp_random_correction_short",                        /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
void ndp_random_correction_short_api(const mxArray *prhs, const mxArray **plhs)
{
  ...
  ndp_random_correction_short(*in, *out);
...
void ndp_random_correction_short_atexit(void)
{
  ...
  ndp_random_correction_short_xil_terminate();
  ndp_random_correction_short_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_ndp_random_correction_short_api.c
 *
 * [EOF]
 */
