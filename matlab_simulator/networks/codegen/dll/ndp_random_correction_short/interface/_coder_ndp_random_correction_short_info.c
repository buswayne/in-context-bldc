 ...
 * File: _coder_ndp_random_correction_short_info.c
 *
...
/* Include Files */
#include "_coder_ndp_random_correction_short_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "QualifiedName",
                emlrtMxCreateString("ndp_random_correction_short"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString(
          ...
          "simulator\\networks\\ndp_random_correction_short.m"));
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(740029.7142708333));
...
/*
 * File trailer for _coder_ndp_random_correction_short_info.c
 *
 * [EOF]
 */
