 ...
 * File: _coder_ndp_random_correction_long_api.c
 *
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "ndp_random_correction_long",                         /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
void ndp_random_correction_long_api(const mxArray *prhs, const mxArray **plhs)
{
  ...
  ndp_random_correction_long(*in, *out);
...
void ndp_random_correction_long_atexit(void)
{
  ...
  ndp_random_correction_long_xil_terminate();
  ndp_random_correction_long_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_ndp_random_correction_long_api.c
 *
 * [EOF]
 */
