...
/* Include Files */
#include "_coder_ndp_short_api.h"
#include "_coder_ndp_short_mex.h"
...
void ndp_short_atexit(void)
{
  ...
  ndp_short_xil_terminate();
  ndp_short_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_ndp_short_api.c
 *
 * [EOF]
 */
