 ...
 * File: _coder_test_H10_10k_mex.c
 *
                 ...
                 const mxArray *prhs[])
{
  ...
  unsafe_test_H10_10k_mexFunction(nlhs, plhs, nrhs, prhs);
 ...
 * Return Type  : void
 */
void unsafe_test_H10_10k_mexFunction(int32_T nlhs, mxArray *plhs[1],
...
/*
 * File trailer for _coder_test_H10_10k_mex.c
 *
 * [EOF]
 */
