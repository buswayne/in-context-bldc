...
I_i_var = optimizableVariable("i_i",[0.1,10],"Type","real");
% I_b_var = optimizableVariable("i_b",[0.1,10],"Type","real");
% I_a_var = optimizableVariable("i_a",[0,1],"Type","real");
% I_p_var = optimizableVariable("i_p",[7,7],"Type","integer")

fun = @(x)cost_function3(x);
...
result = bayesopt(fun, [I_r_var I_l_var I_f_var I_i_var],"Verbose",2, "AcquisitionFunctionName","expected-improvement-plus", NumSeedPoints=400, MaxObjectiveEvaluations=1000, ExplorationRatio=0.7);
