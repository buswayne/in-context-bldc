...
result = bayesopt(fun, [I_r_var I_l_var I_f_var I_i_var I_omega_var],"Verbose",2, "AcquisitionFunctionName","expected-improvement-plus", NumSeedPoints=400, MaxObjectiveEvaluations=800, ExplorationRatio=0.7);
