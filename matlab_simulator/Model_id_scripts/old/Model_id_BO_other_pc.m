...
p1 = optimizableVariable("p1",[200,350],"Type","real");
p2 = optimizableVariable("p2",[50,200],"Type","real");
p3 = optimizableVariable("p3",[1,30],"Type","real");
p4 = optimizableVariable("p4",[30,500],"Type","real");
...
result = bayesopt(fun, [p1,p2,p3,p4],"Verbose",2, ...
    ...
    "UseParallel",true, ...
    NumSeedPoints=150, MaxObjectiveEvaluations=400, ExplorationRatio=0.5);
