...
real_data_path = fullfile(temp_name{1}, "in-context-bldc","data","CL_experiments_double_sensor_low_speed\final\inertia13_ki-0.0029-kp-3.0000\2025-03-25--17-39-43_exp   2.csv");
...
fun = @(var) EKF_tuning_ab_cost_function6(var, input_list, output_list, omega, [Rs,Ls,Kt,J,Ts]);

% these are the order of magnitude of the elements on the diagonal in Q
p1 = optimizableVariable("p1",[-6,6],"Type","real"); %Q1
p2 = optimizableVariable("p2",[-6,6],"Type","real"); %Q2
p3 = optimizableVariable("p3",[-6,6],"Type","real"); %Q3
p4 = optimizableVariable("p4",[-6,6],"Type","real"); %Q4
p5 = optimizableVariable("p5",[-6,6],"Type","real"); %P04

result_kf = bayesopt(fun, [p1,p2,p3,p4,p5],"Verbose",2, ...
    "AcquisitionFunctionName","expected-improvement-plus", ...
    "UseParallel",true, ...
    NumSeedPoints=100, MaxObjectiveEvaluations=400, ExplorationRatio=0.5);
