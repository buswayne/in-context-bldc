...
fun = @(P_BO_list) EKF_tuning_cost_function(P_BO_list, input_list, output_list, omega, [Rs,Ls,Kt,J,Ts]);

% these are the order of magnitude of the elements on the diagonal in Q
p1 = optimizableVariable("p1",[-3,3],"Type","real");
p2 = optimizableVariable("p2",[-5,8],"Type","real");
p3 = optimizableVariable("p3",[-3,3],"Type","real");
p4 = optimizableVariable("p4",[-3,3],"Type","real");

result_kf = bayesopt(fun, [p1,p2,p3,p4],"Verbose",2, ...
    "AcquisitionFunctionName","expected-improvement-plus", ...
    "UseParallel",true, ...
    NumSeedPoints=100, MaxObjectiveEvaluations=800, ExplorationRatio=0.5);
