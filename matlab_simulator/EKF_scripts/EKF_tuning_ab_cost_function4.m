function error = EKF_tuning_ab_cost_function4(var, input_list, output_list, theta_list, P_BLDC_list)
...
theta_pred = mod(theta_pred+pi, pi*2)-pi;

error = mse(theta_list, theta_pred);
