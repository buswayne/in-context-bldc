...
folder_name = sprintf('%02.0f_percent_low_speed', perturbation_percent);
...
for idx_exp = 1:N_exp
    ...
    reference_speed(time <= 4.5) = rand() * (max_speed-min_speed) + min_speed;
    reference_speed(time <= 2.5) = rand() * (max_speed-min_speed) + min_speed;
