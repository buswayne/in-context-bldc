...
BLDC.PolePairs = 7;
BLDC.StatorPhaseResistance = 0.994*0.15862;
BLDC.InductanceLd = 0.995e-3*0.27791;
BLDC.InductanceLq = BLDC.InductanceLd;
BLDC.InductanceL0 = BLDC.InductanceLd;
BLDC.FluxLinkage = 48/BLDC.RatedSpeed/(BLDC.PolePairs)*0.56765;
BLDC.Inertia = 44e-07*3.3338;
BLDC.BreakawayFrictionTorque = 0.002130661000000 *1e-3; %??
BLDC.CoulombFrictionTorque = 0.002130661000000 *1e-3; %??
BLDC.ViscousFrictionCoefficient = 0.0083*1e-6*1.5738;
