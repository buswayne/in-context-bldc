...
save_path = "C:\Users\39340\OneDrive - Politecnico di Milano\in-context-bldc-data\simulated_with_alfa_beta_alt";
...
save_filepath = fullfile(save_path, folder + "_with_alfa_beta_alt");
[~, ~] = mkdir(save_filepath);
...
for file = file_list
    ...
    theta_e_grad = theta * 180 / pi * 7 * i_omega;
