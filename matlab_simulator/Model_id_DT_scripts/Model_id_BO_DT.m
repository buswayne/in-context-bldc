...
bayes_save_file_name = fullfile(temp_name{1}, "in-context-bldc", "matlab_simulator","BO_results_DT", name);
...
real_data_path = fullfile(temp_name{1}, "in-context-bldc","data","OL_experiments_current_profile\final_fixed\inertia" + inertia_number + "_ki-0.0029-kp-3.0000");
...
V_d = data.vd(1000:5000);
V_q = data.vq(1000:5000);
I_d = data.id(1000:5000);
I_q = data.iq(1000:5000);
omega = data.omega(1000:5000);
theta_e = data.theta_e(1000:5000);
