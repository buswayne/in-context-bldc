function [dx, y] = bldcBOModel_dq_speed_input(t, x, u, p, varargin)
    ...
    %       0, P_lambda_J, -B_J, 0;
    %       0, 0, P, 0];
    A = [ -R_Ld, omega*inv_Ld/inv_Lq;
         -omega*inv_Lq/inv_Ld, -R_Lq];
    ...
    D = [0, 0, 0; 0, 0, 0]; % No direct feedthrough
