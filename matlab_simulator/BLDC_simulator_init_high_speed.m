...
savepath_tmp = "C:/Users/81C3009S/OneDrive/Desktop/Tesi/data/rand_traj";
...
for idx_exp = 1:N_exp
    ...
    reference_speed(time <= 4.5) = 0.23 * max_speed;
    reference_speed(time <= 2.5) = 0.67 * max_speed;
