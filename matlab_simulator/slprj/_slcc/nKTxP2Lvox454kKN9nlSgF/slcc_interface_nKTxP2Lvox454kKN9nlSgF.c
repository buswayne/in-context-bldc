/* Include files */
#include "rtwtypes.h"
#include "slcc_interface_nKTxP2Lvox454kKN9nlSgF.h"
...
const char_T *get_dll_checksum_nKTxP2Lvox454kKN9nlSgF(void)
{
    return "8dS2QbvkFjkqPaZ0RKAhOE";
}

void net_predict_L_40k_nKTxP2Lvox454kKN9nlSgF(const real_T in[60], real32_T out[10])
{
