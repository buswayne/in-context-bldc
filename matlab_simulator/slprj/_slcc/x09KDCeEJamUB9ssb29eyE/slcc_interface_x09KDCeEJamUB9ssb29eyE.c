/* Include files */
#include "rtwtypes.h"
#include "slcc_interface_x09KDCeEJamUB9ssb29eyE.h"
...
void get_net_predict_L_40k_nestLockGlobal_addr_x09KDCeEJamUB9ssb29eyE(void ***varAddr)
{
    *varAddr = &net_predict_L_40k_nestLockGlobal;
}

void get_rtNaN_addr_x09KDCeEJamUB9ssb29eyE(real_T **varAddr)
{
    *varAddr = &rtNaN;
}

void get_rtInfF_addr_x09KDCeEJamUB9ssb29eyE(real32_T **varAddr)
{
    *varAddr = &rtInfF;
}

void get_rtInf_addr_x09KDCeEJamUB9ssb29eyE(real_T **varAddr)
{
    *varAddr = &rtInf;
}

void get_rtNaNF_addr_x09KDCeEJamUB9ssb29eyE(real32_T **varAddr)
{
    *varAddr = &rtNaNF;
}

void get_rtMinusInf_addr_x09KDCeEJamUB9ssb29eyE(real_T **varAddr)
{
    *varAddr = &rtMinusInf;
}

void get_rtMinusInfF_addr_x09KDCeEJamUB9ssb29eyE(real32_T **varAddr)
{
    *varAddr = &rtMinusInfF;
}

void get_isInitialized_net_predict_L_40k_addr_x09KDCeEJamUB9ssb29eyE(boolean_T **varAddr)
{
    *varAddr = &isInitialized_net_predict_L_40k;
}

const char_T *get_dll_checksum_x09KDCeEJamUB9ssb29eyE(void)
{
    return "w3SvdOt6SUFr6gugxe89ZD";
}

int32_T main_x09KDCeEJamUB9ssb29eyE(int32_T argc, char_T **argv)
{
    return main(argc, argv);
}

void main_net_predict_L_40k_x09KDCeEJamUB9ssb29eyE(void)
{
    main_net_predict_L_40k();
}

void net_predict_L_40k_x09KDCeEJamUB9ssb29eyE(const real_T in[60], real32_T out[10])
{
    net_predict_L_40k(in, out);
}

void net_predict_L_40k_terminate_x09KDCeEJamUB9ssb29eyE(void)
{
}

boolean_T rtIsInf_x09KDCeEJamUB9ssb29eyE(real_T value)
{
    (void)value;
    return false;
}

boolean_T rtIsInfF_x09KDCeEJamUB9ssb29eyE(real32_T value)
{
    (void)value;
    return false;
}

boolean_T rtIsNaN_x09KDCeEJamUB9ssb29eyE(real_T value)
{
    (void)value;
    return false;
}

boolean_T rtIsNaNF_x09KDCeEJamUB9ssb29eyE(real32_T value)
{
    (void)value;
    return false;
}

void net_predict_L_40k_initialize_x09KDCeEJamUB9ssb29eyE(void)
{
}

void dlnetwork_predict_x09KDCeEJamUB9ssb29eyE(const real32_T varargin_1_Data[60], real32_T varargout_1_Data[10])
{
...
const uint8_T *get_checksum_source_info(int32_T *size) {
    static const uint8_T data[116543] = {
...
1U, 0U, 0U, 0U, 2U, 0U, 0U, 0U, 14U, 0U, 0U, 0U, 16U, 95U, 0U, 0U, 
6U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 9U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 
5U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 1U, 0U, 0U, 0U, 224U, 94U, 0U, 0U, 
1U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 2U, 0U, 0U, 0U, 224U, 94U, 0U, 0U, 
0U, 1U, 73U, 77U, 0U, 0U, 0U, 0U, 14U, 0U, 0U, 0U, 64U, 94U, 0U, 0U, 
...
14U, 0U, 0U, 0U, 248U, 93U, 0U, 0U, 6U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 
...
14U, 0U, 0U, 0U, 184U, 93U, 0U, 0U, 6U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 
...
9U, 0U, 0U, 0U, 32U, 0U, 0U, 0U, 0U, 0U, 0U, 223U, 45U, 48U, 221U, 65U, 
0U, 0U, 0U, 210U, 5U, 221U, 229U, 65U, 0U, 0U, 128U, 194U, 251U, 132U, 211U, 65U, 
0U, 0U, 0U, 130U, 79U, 52U, 197U, 65U, 14U, 0U, 0U, 0U, 24U, 16U, 0U, 0U, 
6U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 2U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 
5U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 1U, 0U, 0U, 0U, 1U, 0U, 0U, 0U, 
...
14U, 0U, 0U, 0U, 72U, 5U, 0U, 0U, 6U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 
2U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 5U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 
1U, 0U, 0U, 0U, 1U, 0U, 0U, 0U, 1U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 
...
100U, 101U, 32U, 34U, 114U, 116U, 95U, 110U, 111U, 110U, 102U, 105U, 110U, 105U, 116U, 101U, 
46U, 104U, 34U, 10U, 35U, 105U, 110U, 99U, 108U, 117U, 100U, 101U, 32U, 34U, 110U, 101U, 
116U, 95U, 112U, 114U, 101U, 100U, 105U, 99U, 116U, 95U, 76U, 95U, 52U, 48U, 107U, 95U, 
...
85U, 80U, 70U, 93U, 0U, 0U, 0U, 0U, 14U, 0U, 0U, 0U, 24U, 1U, 0U, 0U, 
6U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 1U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 
5U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 1U, 0U, 0U, 0U, 3U, 0U, 0U, 0U, 
