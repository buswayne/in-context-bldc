/* Include files */
#include "rtwtypes.h"
#include "slcc_interface_nV8soEoygUDUPgIRBK2wrH.h"
...
void get_rtInf_addr_nV8soEoygUDUPgIRBK2wrH(real_T **varAddr)
{
    *varAddr = &rtInf;
}

void get_rtInfF_addr_nV8soEoygUDUPgIRBK2wrH(real32_T **varAddr)
{
    *varAddr = &rtInfF;
}

void get_rtNaNF_addr_nV8soEoygUDUPgIRBK2wrH(real32_T **varAddr)
{
    *varAddr = &rtNaNF;
}

void get_rtMinusInfF_addr_nV8soEoygUDUPgIRBK2wrH(real32_T **varAddr)
{
    *varAddr = &rtMinusInfF;
}

void get_net_predict_L_40k_nestLockGlobal_addr_nV8soEoygUDUPgIRBK2wrH(void ***varAddr)
{
    *varAddr = &net_predict_L_40k_nestLockGlobal;
}

void get_isInitialized_net_predict_L_40k_addr_nV8soEoygUDUPgIRBK2wrH(boolean_T **varAddr)
{
    *varAddr = &isInitialized_net_predict_L_40k;
}

void get_rtMinusInf_addr_nV8soEoygUDUPgIRBK2wrH(real_T **varAddr)
{
    *varAddr = &rtMinusInf;
}

void get_rtNaN_addr_nV8soEoygUDUPgIRBK2wrH(real_T **varAddr)
{
    *varAddr = &rtNaN;
}

const char_T *get_dll_checksum_nV8soEoygUDUPgIRBK2wrH(void)
{
    return "F92Bj9HHsP7owbncPcf9sE";
}

void net_predict_L_40k_nV8soEoygUDUPgIRBK2wrH(const real_T in[60], real32_T out[10])
{
    net_predict_L_40k(in, out);
}

void net_predict_L_40k_initialize_nV8soEoygUDUPgIRBK2wrH(void)
{
}

void dlnetwork_predict_nV8soEoygUDUPgIRBK2wrH(const real32_T varargin_1_Data[60], real32_T varargout_1_Data[10])
{
    (void)varargin_1_Data;
    (void)varargout_1_Data;
}

boolean_T rtIsInf_nV8soEoygUDUPgIRBK2wrH(real_T value)
{
    (void)value;
    return false;
}

boolean_T rtIsInfF_nV8soEoygUDUPgIRBK2wrH(real32_T value)
{
    (void)value;
    return false;
}

boolean_T rtIsNaN_nV8soEoygUDUPgIRBK2wrH(real_T value)
{
    (void)value;
    return false;
}

boolean_T rtIsNaNF_nV8soEoygUDUPgIRBK2wrH(real32_T value)
{
    (void)value;
    return false;
}
...
const uint8_T *get_checksum_source_info(int32_T *size) {
    static const uint8_T data[77292] = {
...
1U, 0U, 0U, 0U, 2U, 0U, 0U, 0U, 14U, 0U, 0U, 0U, 80U, 63U, 0U, 0U, 
6U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 9U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 
5U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 1U, 0U, 0U, 0U, 32U, 63U, 0U, 0U, 
1U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 2U, 0U, 0U, 0U, 32U, 63U, 0U, 0U, 
0U, 1U, 73U, 77U, 0U, 0U, 0U, 0U, 14U, 0U, 0U, 0U, 128U, 62U, 0U, 0U, 
...
14U, 0U, 0U, 0U, 56U, 62U, 0U, 0U, 6U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 
...
14U, 0U, 0U, 0U, 248U, 61U, 0U, 0U, 6U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 
...
0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 1U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 
9U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 14U, 0U, 0U, 0U, 136U, 8U, 0U, 0U, 
6U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 1U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 
5U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 1U, 0U, 0U, 0U, 13U, 0U, 0U, 0U, 
...
0U, 0U, 0U, 234U, 254U, 183U, 178U, 65U, 0U, 0U, 160U, 199U, 225U, 254U, 229U, 65U, 
0U, 0U, 128U, 75U, 126U, 252U, 224U, 65U, 0U, 0U, 192U, 219U, 31U, 187U, 208U, 65U, 
...
111U, 110U, 102U, 105U, 110U, 105U, 116U, 101U, 46U, 104U, 34U, 10U, 91U, 72U, 74U, 116U, 
90U, 79U, 52U, 85U, 83U, 122U, 66U, 56U, 86U, 70U, 100U, 68U, 107U, 113U, 54U, 113U, 
52U, 104U, 71U, 93U, 0U, 0U, 0U, 0U, 14U, 0U, 0U, 0U, 216U, 0U, 0U, 0U, 
6U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 4U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 
...
101U, 110U, 92U, 108U, 105U, 98U, 92U, 110U, 101U, 116U, 95U, 112U, 114U, 101U, 100U, 105U, 
99U, 116U, 95U, 76U, 95U, 52U, 48U, 107U, 92U, 110U, 101U, 116U, 95U, 112U, 114U, 101U, 
100U, 105U, 99U, 116U, 95U, 76U, 95U, 52U, 48U, 107U, 46U, 99U, 91U, 72U, 74U, 116U, 
90U, 79U, 52U, 85U, 83U, 122U, 66U, 56U, 86U, 70U, 100U, 68U, 107U, 113U, 54U, 113U, 
52U, 104U, 71U, 93U, 0U, 0U, 0U, 0U, 14U, 0U, 0U, 0U, 200U, 0U, 0U, 0U, 
6U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 1U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 
5U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 1U, 0U, 0U, 0U, 2U, 0U, 0U, 0U, 
