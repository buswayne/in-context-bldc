/* Include files */
#include "rtwtypes.h"
#include "slcc_interface_GvyovTsDaeyBxncDqZQ8uD.h"
...
void get_isInitialized_net_predict_L_40k_addr_GvyovTsDaeyBxncDqZQ8uD(boolean_T **varAddr)
{
    *varAddr = &isInitialized_net_predict_L_40k;
}

void get_rtMinusInfF_addr_GvyovTsDaeyBxncDqZQ8uD(real32_T **varAddr)
{
    *varAddr = &rtMinusInfF;
}

void get_rtInfF_addr_GvyovTsDaeyBxncDqZQ8uD(real32_T **varAddr)
{
    *varAddr = &rtInfF;
}

void get_rtNaNF_addr_GvyovTsDaeyBxncDqZQ8uD(real32_T **varAddr)
{
    *varAddr = &rtNaNF;
}

void get_rtInf_addr_GvyovTsDaeyBxncDqZQ8uD(real_T **varAddr)
{
    *varAddr = &rtInf;
}

void get_rtNaN_addr_GvyovTsDaeyBxncDqZQ8uD(real_T **varAddr)
{
    *varAddr = &rtNaN;
}

void get_net_predict_L_40k_nestLockGlobal_addr_GvyovTsDaeyBxncDqZQ8uD(void ***varAddr)
{
    *varAddr = &net_predict_L_40k_nestLockGlobal;
}

void get_rtMinusInf_addr_GvyovTsDaeyBxncDqZQ8uD(real_T **varAddr)
{
    *varAddr = &rtMinusInf;
}

const char_T *get_dll_checksum_GvyovTsDaeyBxncDqZQ8uD(void)
{
    return "UXPPbEVj4SrgUyjIAfZfYE";
}

void net_predict_L_40k_GvyovTsDaeyBxncDqZQ8uD(const real_T in[60], real32_T out[10])
{
    net_predict_L_40k(in, out);
}

void net_predict_L_40k_initialize_GvyovTsDaeyBxncDqZQ8uD(void)
{
}

void dlnetwork_predict_GvyovTsDaeyBxncDqZQ8uD(const real32_T varargin_1_Data[60], real32_T varargout_1_Data[10])
{
    (void)varargin_1_Data;
    (void)varargout_1_Data;
}

boolean_T rtIsInf_GvyovTsDaeyBxncDqZQ8uD(real_T value)
{
    (void)value;
    return false;
}

boolean_T rtIsInfF_GvyovTsDaeyBxncDqZQ8uD(real32_T value)
{
    (void)value;
    return false;
}

boolean_T rtIsNaN_GvyovTsDaeyBxncDqZQ8uD(real_T value)
{
    (void)value;
    return false;
}

boolean_T rtIsNaNF_GvyovTsDaeyBxncDqZQ8uD(real32_T value)
{
    (void)value;
    return false;
}
...
const uint8_T *get_checksum_source_info(int32_T *size) {
    static const uint8_T data[113969] = {
...
1U, 0U, 0U, 0U, 2U, 0U, 0U, 0U, 14U, 0U, 0U, 0U, 40U, 93U, 0U, 0U, 
6U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 9U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 
5U, 0U, 0U, 0U, 8U, 0U, 0U, 0U, 1U, 0U, 0U, 0U, 248U, 92U, 0U, 0U, 
1U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 2U, 0U, 0U, 0U, 248U, 92U, 0U, 0U, 
0U, 1U, 73U, 77U, 0U, 0U, 0U, 0U, 14U, 0U, 0U, 0U, 88U, 92U, 0U, 0U, 
...
14U, 0U, 0U, 0U, 16U, 92U, 0U, 0U, 6U, 0U, 0U, 0U, 8U, 0U, 0U, 0U,